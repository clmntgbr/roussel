 ...
 */
final class Version20190708145354 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, created_by INT DEFAULT NULL, preview_id INT DEFAULT NULL, title LONGTEXT DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, content LONGTEXT DEFAULT NULL, time_to_read DOUBLE PRECISION DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_23A0E66DE12AB56 (created_by), UNIQUE INDEX UNIQ_23A0E66CDE46FDB (preview_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
