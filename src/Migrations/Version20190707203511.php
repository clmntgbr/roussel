 ...
 */
final class Version20190707203511 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE investment_fund ADD street VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, ADD city VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, ADD postal_code VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, ADD country VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP address_id');
        ...
        $this->addSql('ALTER TABLE society ADD street VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, ADD city VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, ADD postal_code VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, ADD country VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP address_id');
    }
}
